 ...
 * @return string
 */
function df_dump($value) {return Df_Core_Dumper::i()->dump($value);}
 ...
 * @return string
 */
function df_preg_replace($pattern, $replacement, $subject) {
 ...
 * @return mixed
 */
function df_print_params(array $params) {return Df_Core_Dumper::i()->dumpArrayElements($params);}
