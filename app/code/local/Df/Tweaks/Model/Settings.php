...
class Df_Tweaks_Model_Settings extends Df_Core_Model_Settings {
	...
	public function cart() {static $r; return $r ?: $r = Df_Tweaks_Model_Settings_Remove::i('cart');}
	...
	public function recentlyComparedProducts() {
		static $r;
		return $r ?: $r = Df_Tweaks_Model_Settings_Remove::i('recently_compared_products');
	}
