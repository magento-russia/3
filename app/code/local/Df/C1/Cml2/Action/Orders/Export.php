...
class Export extends \Df\C1\Cml2\Action\GenericExport {
	...
	protected function createDocument() {return
		\Df\C1\Cml2\Export\Document\Orders::i($this->getOrders())
	;}
	 ...
	 * @return ZD
	 */
	private function getLastProcessedTime() {return dfc($this, function() {
		/** @var ZD $result */
	 ...
	 */
	private function getOrders() {return dfc($this, function() {
